...
```
![image](https://github.com/Suthera213/OOP2565-Week-13/assets/115066359/19edbbe3-91eb-4bcc-9ff7-b54d4b094f3d)
...
```
![image](https://github.com/Suthera213/OOP2565-Week-13/assets/115066359/d58393e8-c986-4b6f-a504-a5e34812b26e)
...
```
![image](https://github.com/Suthera213/OOP2565-Week-13/assets/115066359/9af3268a-11ed-4172-ba61-5ddef0921e98)
...
```
![image](https://github.com/Suthera213/OOP2565-Week-13/assets/115066359/801e8425-c3fd-4d20-a530-71bf9f279599)
...
namespace GenericExample
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("------ push -----");
            stringStack.Push("64030213");
            stringStack.Push("Suthera");
            stringStack.Push("Boonmalert");
            stringStack.Info();
            Console.WriteLine("------ pop -----");
            ...
            stringStack.Info();
            Console.WriteLine("------ push -----");
            stringStack.Push("Areena");
            stringStack.Push("Sutheraaa");
            stringStack.Push("TREASURE");
            stringStack.Info();
        }
    }
}
```
![image](https://github.com/Suthera213/OOP2565-Week-13/assets/115066359/456c7f9c-9e41-49d5-ae51-d2bfa1c640a1)
