...
```
### ผลการรันโปรแกรม
![image](https://user-images.githubusercontent.com/115037574/236240317-1bc93d4d-7c69-4c03-a998-255542384df9.png)
...
```
### ผลการรันโปรแกรม
![image](https://user-images.githubusercontent.com/115037574/236240810-65446360-6999-431e-9c9f-2eb88eb05b87.png)
...
```
### ผลการรันโปรแกรม
![image](https://user-images.githubusercontent.com/115037574/236243333-8db9fc88-db3d-4bc5-a2f4-02799664129a.png)
...
namespace GenericExample
{
    ...
    internal class Program
    {
        ...
        {
            IntegerStack integerStack = new IntegerStack();
            Console.WriteLine("------ IntegerStack -----");
            integerStack.Push(1);
            integerStack.Push(2);
            integerStack.Push(3);
            integerStack.Info();
