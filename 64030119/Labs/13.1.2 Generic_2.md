...
```
![image](https://github.com/PiyatidaPh/Week-13/assets/115066285/42d4a7a7-3977-4646-b423-cede0851a858)
 ...
 namespace GenericExample
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            stringstack.Push("64030119");
            stringstack.Push("Piyatida");
            stringstack.Push("Phongkorsang");
            stringstack.Info();
            Console.WriteLine("------ pop -----");
            ...
            stringstack.Info();
            Console.WriteLine("------ push -----");
            stringstack.Push("Palmmie");
            stringstack.Push("piyatidaps");
            stringstack.Push("plmss");
            stringstack.Info();
        }
    }
}
 ```
 ![image](https://github.com/PiyatidaPh/Week-13/assets/115066285/ff925033-8932-46ac-9b77-fe33397dabf7)
