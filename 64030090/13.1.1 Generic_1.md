...
```
![image](https://user-images.githubusercontent.com/115066356/236410311-81e180b3-f7db-4982-b574-a8cd7c9a6d15.png)
...
```
![image](https://user-images.githubusercontent.com/115066356/236410438-d585d3cb-0f09-4282-a1f7-6f5a4c082e80.png)
...
```
![image](https://user-images.githubusercontent.com/115066356/236410626-ebc65d53-3dfc-4931-b0c4-2a3ab657b72c.png)
...
```
![image](https://user-images.githubusercontent.com/115066356/236410817-aa7f1c3d-f774-4e36-a93e-0c8bc31da9d4.png)
...
namespace GenericExample
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("------ push -----");
            stringStack.Push("64030090");
            stringStack.Push("Nanapon");
            stringStack.Push("Winya");
            stringStack.Info();
            Console.WriteLine("------ pop -----");
            ...
            stringStack.Info();
            Console.WriteLine("------ push -----");
            stringStack.Push("Poon");
            stringStack.Push("nanapon.poon");
            stringStack.Push("thepoon");
            stringStack.Info();
        }
    }
}
```
![image](https://user-images.githubusercontent.com/115066356/236412191-2bd189b3-aaf2-4510-9884-b29c9d2e2e21.png)
