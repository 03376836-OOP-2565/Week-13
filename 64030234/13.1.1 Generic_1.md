...
![Lab13.1.1.1](./Images/Lab13.1.1.1.png)
...
![Lab13.1.1.2](./Images/Lab13.1.1.2.png)
...
![Lab13.1.1.3](./Images/Lab13.1.1.3.png)
...
![Lab13.1.1.4](./Images/Lab13.1.1.4.png)
...
namespace GenericExample
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("------ push -----");
            stringStack.Push("64030234");
            stringStack.Push("Kuntida");
            stringStack.Push("Kesorn");
            stringStack.Info();
            Console.WriteLine("------ pop -----");
            ...
            stringStack.Info();
            Console.WriteLine("------ push -----");
            stringStack.Push("Cake");
            stringStack.Push("kuntida_.565");
            stringStack.Push("64030234 Kuntida");
            stringStack.Info();
        }
    }
}
