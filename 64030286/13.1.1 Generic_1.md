...
```
![image](https://user-images.githubusercontent.com/115066261/236114230-67d49376-c349-4bc3-8eac-59ed13bb46d2.png)
...
```
![image](https://user-images.githubusercontent.com/115066261/236114362-7ca616c0-4058-415d-9f9a-7074ede94124.png)
...
```
![image](https://user-images.githubusercontent.com/115066261/236114515-c5940d68-26fc-4a56-9eea-1ecf8750685a.png)
...
```
![image](https://user-images.githubusercontent.com/115066261/236114639-94d85aaa-9619-413d-891a-f21bbeb3a3f2.png)
...
namespace GenericExample
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            stringStack.Push("POPPY");
            stringStack.Info();
        }
    }
}
```
![image](https://github.com/Pipaul1601/Week-13/assets/115067018/c9d1b4cd-d0cc-4dc3-9814-a8582f715223)
