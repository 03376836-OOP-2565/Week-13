 ...
 namespace GenericExample
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            stringstack.Push("Nuttanucha");
            stringstack.Push("Loapet");
            stringstack.Info();
            Console.WriteLine("------ pop -----");
            ...
            stringstack.Info();
            Console.WriteLine("------ push -----");
            stringstack.Push("Kam");
            stringstack.Push("Kammam");
 ...
 ```
![ภาพ](https://user-images.githubusercontent.com/112167732/236676877-327b1a73-d09b-4b3a-a900-edbed185c6dd.png)
